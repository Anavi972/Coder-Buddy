...
class Plan(BaseModel):
    ...
    description: str = Field(
        description="A oneline description of the app to be built, e.g. 'A web application for managing personal "
                    "finances'")
    techstack: str = Field(
...
class ImplementationTask(BaseModel):
    ...
    task_description: str = Field(
        description="A detailed description of the task to be performed on the file, e.g. 'add user authentication', "
